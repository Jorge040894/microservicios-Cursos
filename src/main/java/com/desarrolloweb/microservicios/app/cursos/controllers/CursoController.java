package com.desarrolloweb.microservicios.app.cursos.controllers;
...
import com.desarrolloweb.microservicios.app.cursos.services.CursoService;
...
public class CursoController extends CommonController<Curso, CursoService> {
	...
	public ResponseEntity<?> aliminarAlumno( @RequestBody Alumno alumno, @PathVariable Long id){
	Optional<Curso> o = this.service.findById(id);
	if (!o.isPresent()) {
		return ResponseEntity.notFound().build();		
		}
